                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div>
								<a class="btn btn-primary" href="<c:url value='/configuracaoGeral/new' />">Cadastrar novo</a>
                            </div>
							<br/>
                            <div class="dataTable_wrapper">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-lista">
                                    ...
                                    <tbody>
										<c:forEach items="${lista}" var="configuracaoGeral">
											<tr class="odd gradeX">
												<td>${configuracaoGeral.descricao}</td>
												<td>${configuracaoGeral.vlr}</td>
												<td>${configuracaoGeral.tipo}</td>
												<td>${configuracaoGeral.funcionalidade}</td>
												<td>${configuracaoGeral.md5}</td>
												<td width="50" style="text-align:center">
													<a href="<c:url value='/configuracaoGeral/edit-${configuracaoGeral.chave}' />" class="btn btn-success btn-circle"><i class="fa fa-edit"></i></a>
												    <a href="#" 
												    	class="btn btn-danger btn-circle"
												    	data-href="<c:url value='/configuracaoGeral/delete-${configuracaoGeral.chave}' />" 
												    	data-toggle="modal" 
