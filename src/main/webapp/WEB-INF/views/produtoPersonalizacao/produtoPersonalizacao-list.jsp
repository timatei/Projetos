                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Listagem de produtoPersonalizacao
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            ...
                            <div>
								<a class="btn btn-primary" href="<c:url value='/produtoPersonalizacao/new' />">Cadastrar novo</a>
                            </div>
							<br/>
                            <div class="dataTable_wrapper">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-lista">
                                    ...
                                    <tbody>
										<c:forEach items="${lista}" var="produtoPersonalizacao">
											<tr class="odd gradeX">
												<td>${produtoPersonalizacao.codproduto}</td>
												<td>${produtoPersonalizacao.codgrupopersonalizacao}</td>
												<td>${produtoPersonalizacao.qtdeMinima}</td>
												<td>${produtoPersonalizacao.qtdeMaxima}</td>
												<td>${produtoPersonalizacao.tipo}</td>
												<td width="50" style="text-align:center">
													<a href="<c:url value='/produtoPersonalizacao/edit-${produtoPersonalizacao.codprodutopersonalizacao}' />" class="btn btn-success btn-circle"><i class="fa fa-edit"></i></a>
												    <a href="#" 
												    	class="btn btn-danger btn-circle"
												    	data-href="<c:url value='/produtoPersonalizacao/delete-${produtoPersonalizacao.codprodutopersonalizacao}' />" 
												    	data-toggle="modal" 
