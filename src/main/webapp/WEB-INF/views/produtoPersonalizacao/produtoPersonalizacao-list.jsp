                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Listagem de produto personalização
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-lista">
                                    ...
                                    <tbody>
										<c:forEach items="${lista}" var="produtoPersonalizacao">
											<tr class="odd gradeX">
												<td>${produtoPersonalizacao.grupoPersonalizacao.descricao}</td>
												<td>${produtoPersonalizacao.produto.descricao}</td>
												<td width="50" style="text-align:center">${produtoPersonalizacao.tipo}</td>
