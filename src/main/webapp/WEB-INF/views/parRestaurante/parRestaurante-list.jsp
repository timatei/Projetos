                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div>
								<a class="btn btn-primary" href="<c:url value='/parRestaurante/new' />">Cadastrar novo</a>
                            </div>
							<br/>
                                ...
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-lista">
                                    <thead>
							      		<tr>
									        ...
									        <th>TrabalharRest</th>
									        <th>ImpCozinha</th>
									        <th>LinhaFinalImpressao</th>
									        <th>ImpExtrato</th>
									        <th width="50" style="text-align:center"></th>
										</tr>
                                    </thead>
                                    <tbody>
										<c:forEach items="${lista}" var="parRestaurante">
											<tr class="odd gradeX">
												<td>${parRestaurante.controleNome}</td>
												<td>${parRestaurante.trabalharRest}</td>
												<td>${parRestaurante.impCozinha}</td>
												<td>${parRestaurante.linhaFinalImpressao}</td>
												<td>${parRestaurante.impExtrato}</td>
												<td width="50" style="text-align:center">
													<a href="<c:url value='/parRestaurante/edit-${parRestaurante.codparrestaurante}' />" class="btn btn-success btn-circle"><i class="fa fa-edit"></i></a>
												    <a href="#" 
												    	class="btn btn-danger btn-circle"
												    	data-href="<c:url value='/parRestaurante/delete-${parRestaurante.codparrestaurante}' />" 
												    	data-toggle="modal" 
