                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div>
								<a class="btn btn-primary" href="<c:url value='/produtoGrupo/new' />">Cadastrar novo</a>
                            </div>
							<br/>
                            <div class="dataTable_wrapper">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-lista">
                                    <thead>
							      		<tr>
									        <th>Descrição</th>
									        <th width="80" style="text-align:center">Des.Touch</th>
                                    ...
                                    <tbody>
										<c:forEach items="${lista}" var="produtoGrupo">
											<tr class="odd gradeX">
												...
												<td width="80" style="text-align:center">${produtoGrupo.desativarTouch}</td>
												<td width="60" style="text-align:center">${produtoGrupo.ordem}</td>
