                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Listagem de resPedidoItemPerso
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            ...
                            <div>
								<a class="btn btn-primary" href="<c:url value='/resPedidoItemPerso/new' />">Cadastrar novo</a>
                            </div>
							<br/>
                            <div class="dataTable_wrapper">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-lista">
                                    ...
                                    <tbody>
										<c:forEach items="${lista}" var="resPedidoItemPerso">
											<tr class="odd gradeX">
												<td>${resPedidoItemPerso.codpedidoitem}</td>
												<td>${resPedidoItemPerso.codproduto}</td>
												<td>${resPedidoItemPerso.codgrupopersonalizacao}</td>
												<td>${resPedidoItemPerso.vlrunit}</td>
												<td>${resPedidoItemPerso.codpedido}</td>
												<td width="50" style="text-align:center">
													<a href="<c:url value='/resPedidoItemPerso/edit-${resPedidoItemPerso.codrespedidoitemperso}' />" class="btn btn-success btn-circle"><i class="fa fa-edit"></i></a>
												    <a href="#" 
												    	class="btn btn-danger btn-circle"
												    	data-href="<c:url value='/resPedidoItemPerso/delete-${resPedidoItemPerso.codrespedidoitemperso}' />" 
												    	data-toggle="modal" 
