                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div>
								<a class="btn btn-primary" href="<c:url value='/resPedido/new' />">Cadastrar novo</a>
                            </div>
							<br/>
                            <div class="dataTable_wrapper">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-lista">
                                    ...
                                    <tbody>
										<c:forEach items="${lista}" var="resPedido">
											<tr class="odd gradeX">
												<td>${resPedido.codcontrole}</td>
												<td>${resPedido.status}</td>
												<td>${resPedido.data}</td>
												<td>${resPedido.total}</td>
												<td>${resPedido.codgarcon}</td>
												<td width="50" style="text-align:center">
													<a href="<c:url value='/resPedido/edit-${resPedido.codpedido}' />" class="btn btn-success btn-circle"><i class="fa fa-edit"></i></a>
												    <a href="#" 
												    	class="btn btn-danger btn-circle"
												    	data-href="<c:url value='/resPedido/delete-${resPedido.codpedido}' />" 
												    	data-toggle="modal" 
