                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Cadastro de grupo personalização
                        </div>
                        <div class="panel-body">
                            <form:form method="POST" modelAttribute="grupoPersonalizacao" class="form form-horizontal has-validation-callback">
                                <form:input type="hidden" path="codGrupoPersonalizacao" id="codGrupoPersonalizacao"/>
								...
								<div class="row">
									...
									<div class="col-sm-8">
                                        <c:choose>
                                            <c:when test="${edit}">
                                                <input type="submit" value="Atualizar" class="btn btn-success custom-width"/> ou <a href="<c:url value='/grupoPersonalizacao/list' />">Desistir</a>
                                            </c:when>
                                            <c:otherwise>
                                                <input type="submit" value="Cadastrar" class="btn btn-success custom-width"/> ou <a href="<c:url value='/grupoPersonalizacao/list' />">Desistir</a>
                                            </c:otherwise>
                                        </c:choose>
									</div>
								</div>
