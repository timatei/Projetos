...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">GrupoPersonalizacaoItem</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>            
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Listagem de grupoPersonalizacaoItem
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            ...
                            <div>
								<a class="btn btn-primary" href="<c:url value='/grupoPersonalizacaoItem/new' />">Cadastrar novo</a>
                            </div>
							<br/>
                            <div class="dataTable_wrapper">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-lista">
                                    ...
                                    <tbody>
										<c:forEach items="${lista}" var="grupoPersonalizacaoItem">
											<tr class="odd gradeX">
												<td>${grupoPersonalizacaoItem.codgrupopersonalizacao}</td>
												<td>${grupoPersonalizacaoItem.codproduto}</td>
												<td>${grupoPersonalizacaoItem.codpesquisa}</td>
												<td width="50" style="text-align:center">
													<a href="<c:url value='/grupoPersonalizacaoItem/edit-${grupoPersonalizacaoItem.codgrupopersonalizacaoitem}' />" class="btn btn-success btn-circle"><i class="fa fa-edit"></i></a>
												    <a href="#" 
												    	class="btn btn-danger btn-circle"
												    	data-href="<c:url value='/grupoPersonalizacaoItem/delete-${grupoPersonalizacaoItem.codgrupopersonalizacaoitem}' />" 
												    	data-toggle="modal" 
