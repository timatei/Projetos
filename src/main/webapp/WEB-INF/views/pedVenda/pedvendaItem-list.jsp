                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div>
								<a class="btn btn-primary" href="<c:url value='/pedvendaItem/new' />">Cadastrar novo</a>
                            </div>
							<br/>
                            <div class="dataTable_wrapper">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-lista">
                                    ...
                                    <tbody>
										<c:forEach items="${lista}" var="pedvendaItem">
											<tr class="odd gradeX">
												<td>${pedvendaItem.codpedvenda}</td>
												<td>${pedvendaItem.codproduto}</td>
												<td>${pedvendaItem.tipopreco}</td>
												<td>${pedvendaItem.qtde}</td>
												<td>${pedvendaItem.descvlr}</td>
												<td width="50" style="text-align:center">
													<a href="<c:url value='/pedvendaItem/edit-${pedvendaItem.codpedvendaitem}' />" class="btn btn-success btn-circle"><i class="fa fa-edit"></i></a>
												    <a href="#" 
												    	class="btn btn-danger btn-circle"
												    	data-href="<c:url value='/pedvendaItem/delete-${pedvendaItem.codpedvendaitem}' />" 
												    	data-toggle="modal" 
