                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div>
								<a class="btn btn-primary" href="<c:url value='/pedvenda/new' />">Cadastrar novo</a>
                            </div>
							<br/>
                            <div class="dataTable_wrapper">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-lista">
                                    ...
                                    <tbody>
										<c:forEach items="${lista}" var="pedvenda">
											<tr class="odd gradeX">
												<td>${pedvenda.codpessoa}</td>
												<td>${pedvenda.tipopreco}</td>
												<td>${pedvenda.dataEntrada}</td>
												<td>${pedvenda.status}</td>
												<td>${pedvenda.descVlr}</td>
												<td width="50" style="text-align:center">
													<a href="<c:url value='/pedvenda/edit-${pedvenda.codpedvenda}' />" class="btn btn-success btn-circle"><i class="fa fa-edit"></i></a>
												    <a href="#" 
												    	class="btn btn-danger btn-circle"
												    	data-href="<c:url value='/pedvenda/delete-${pedvenda.codpedvenda}' />" 
												    	data-toggle="modal" 
