                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form:form method="POST" modelAttribute="formapagamento" class="form form-horizontal has-validation-callback">
								...
								<div class="form-group">
									<label class="col-sm-2 control-label" for="inline-suggestions">Parcelas:</label>
									<div class="col-sm-8">
										<form:input type="text" path="parcelas" id="parcelas" class="form-control has-suggestions"/>
	                                    <div class="has-error">
	                                        <form:errors path="parcelas" class="label label-danger"/>
	                                    </div>
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="col-sm-8">
                                        <c:choose>
                                            <c:when test="${edit}">
                                                <input type="submit" value="Atualizar" class="btn btn-success custom-width"/> ou <a href="<c:url value='/formapagamento/list' />">Desistir</a>
                                            </c:when>
                                            <c:otherwise>
                                                <input type="submit" value="Cadastrar" class="btn btn-success custom-width"/> ou <a href="<c:url value='/formapagamento/list' />">Desistir</a>
                                            </c:otherwise>
                                        </c:choose>
									</div>
								</div>
