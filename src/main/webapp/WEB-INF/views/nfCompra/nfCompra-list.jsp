                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div>
								<a class="btn btn-primary" href="<c:url value='/nfcompra/new' />">Cadastrar novo</a>
                            </div>
							<br/>
                                ...
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-lista">
                                    <thead>
							      		<tr>
									        <th>Codpessoa</th>
									        <th>Codcfop</th>
									        <th>Codtransportadora</th>
									        <th>Codformapagamento</th>
									        <th>Status</th>
									        <th width="50" style="text-align:center"></th>
										</tr>
                                    </thead>
                                    <tbody>
										<c:forEach items="${lista}" var="nfcompra">
											<tr class="odd gradeX">
												<td>${nfcompra.codpessoa}</td>
												<td>${nfcompra.codcfop}</td>
												<td>${nfcompra.codtransportadora}</td>
												<td>${nfcompra.codformapagamento}</td>
												<td>${nfcompra.status}</td>
												<td width="50" style="text-align:center">
													<a href="<c:url value='/nfcompra/edit-${nfcompra.codnfcompra}' />" class="btn btn-success btn-circle"><i class="fa fa-edit"></i></a>
												    <a href="#" 
												    	class="btn btn-danger btn-circle"
												    	data-href="<c:url value='/nfcompra/delete-${nfcompra.codnfcompra}' />" 
												    	data-toggle="modal" 
