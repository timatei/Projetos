                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div>
								<a class="btn btn-primary" href="<c:url value='/ajusteEstoque/new' />">Cadastrar novo</a>
                            </div>
							<br/>
                            <div class="dataTable_wrapper">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-lista">
                                    ...
                                    <tbody>
										<c:forEach items="${lista}" var="ajusteEstoque">
											<tr class="odd gradeX">
												<td>${ajusteEstoque.data}</td>
												<td>${ajusteEstoque.tipo}</td>
												<td>${ajusteEstoque.obs}</td>
												<td>${ajusteEstoque.iventProc}</td>
												<td>${ajusteEstoque.ivent}</td>
												<td width="50" style="text-align:center">
													<a href="<c:url value='/ajusteEstoque/edit-${ajusteEstoque.codajusteestoque}' />" class="btn btn-success btn-circle"><i class="fa fa-edit"></i></a>
												    <a href="#" 
												    	class="btn btn-danger btn-circle"
												    	data-href="<c:url value='/ajusteEstoque/delete-${ajusteEstoque.codajusteestoque}' />" 
												    	data-toggle="modal" 
