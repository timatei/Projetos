                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div>
								<a class="btn btn-primary" href="<c:url value='/ajusteEstoqueItem/new' />">Cadastrar novo</a>
                            </div>
							<br/>
                            <div class="dataTable_wrapper">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-lista">
                                    ...
                                    <tbody>
										<c:forEach items="${lista}" var="ajusteEstoqueItem">
											<tr class="odd gradeX">
												<td>${ajusteEstoqueItem.codajusteestoque}</td>
												<td>${ajusteEstoqueItem.codpesquisa}</td>
												<td>${ajusteEstoqueItem.codproduto}</td>
												<td>${ajusteEstoqueItem.qtde}</td>
												<td>${ajusteEstoqueItem.numlote}</td>
												<td width="50" style="text-align:center">
													<a href="<c:url value='/ajusteEstoqueItem/edit-${ajusteEstoqueItem.codajusteestoqueitem}' />" class="btn btn-success btn-circle"><i class="fa fa-edit"></i></a>
												    <a href="#" 
												    	class="btn btn-danger btn-circle"
												    	data-href="<c:url value='/ajusteEstoqueItem/delete-${ajusteEstoqueItem.codajusteestoqueitem}' />" 
												    	data-toggle="modal" 
