                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div>
								<a class="btn btn-primary" href="<c:url value='/impressao/new' />">Cadastrar novo</a>
                            </div>
							<br/>
                            <div class="dataTable_wrapper">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-lista">
                                    ...
                                    <tbody>
										<c:forEach items="${lista}" var="impressao">
											<tr class="odd gradeX">
												<td>${impressao.datahora}</td>
												<td>${impressao.usuario}</td>
												<td>${impressao.centralizador}</td>
												<td>${impressao.finalizado}</td>
												<td>${impressao.texto}</td>
												<td width="50" style="text-align:center">
													<a href="<c:url value='/impressao/edit-${impressao.codimpressao}' />" class="btn btn-success btn-circle"><i class="fa fa-edit"></i></a>
												    <a href="#" 
												    	class="btn btn-danger btn-circle"
												    	data-href="<c:url value='/impressao/delete-${impressao.codimpressao}' />" 
												    	data-toggle="modal" 
