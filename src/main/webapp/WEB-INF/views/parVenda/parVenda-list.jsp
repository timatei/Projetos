                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div>
								<a class="btn btn-primary" href="<c:url value='/parVenda/new' />">Cadastrar novo</a>
                            </div>
							<br/>
                            <div class="dataTable_wrapper">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-lista">
                                    ...
                                    <tbody>
										<c:forEach items="${lista}" var="parVenda">
											<tr class="odd gradeX">
												<td>${parVenda.ecfModelo}</td>
												<td>${parVenda.ecfPorta}</td>
												<td>${parVenda.ecfTimeout}</td>
												<td>${parVenda.ecfIntervalo}</td>
												<td width="50" style="text-align:center">
													<a href="<c:url value='/parVenda/edit-${parVenda.codparvenda}' />" class="btn btn-success btn-circle"><i class="fa fa-edit"></i></a>
												    <a href="#" 
												    	class="btn btn-danger btn-circle"
												    	data-href="<c:url value='/parVenda/delete-${parVenda.codparvenda}' />" 
												    	data-toggle="modal" 
