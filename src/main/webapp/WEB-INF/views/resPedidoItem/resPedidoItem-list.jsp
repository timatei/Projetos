                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div>
								<a class="btn btn-primary" href="<c:url value='/resPedidoItem/new' />">Cadastrar novo</a>
                            </div>
							<br/>
                            <div class="dataTable_wrapper">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-lista">
                                    ...
                                    <tbody>
										<c:forEach items="${lista}" var="resPedidoItem">
											<tr class="odd gradeX">
												<td>${resPedidoItem.codpedido}</td>
												<td>${resPedidoItem.codproduto}</td>
												<td>${resPedidoItem.codgarcon}</td>
												<td>${resPedidoItem.qtde}</td>
												<td>${resPedidoItem.vlrunit}</td>
												<td width="50" style="text-align:center">
													<a href="<c:url value='/resPedidoItem/edit-${resPedidoItem.codpedidoitem}' />" class="btn btn-success btn-circle"><i class="fa fa-edit"></i></a>
												    <a href="#" 
												    	class="btn btn-danger btn-circle"
												    	data-href="<c:url value='/resPedidoItem/delete-${resPedidoItem.codpedidoitem}' />" 
												    	data-toggle="modal" 
