                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div>
								<a class="btn btn-primary" href="<c:url value='/contasBaixas/new' />">Cadastrar novo</a>
                            </div>
							<br/>
                            <div class="dataTable_wrapper">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-lista">
                                    ...
                                    <tbody>
										<c:forEach items="${lista}" var="contasBaixas">
											<tr class="odd gradeX">
												<td>${contasBaixas.codconta}</td>
												<td>${contasBaixas.codmoeda}</td>
												<td>${contasBaixas.dtpag}</td>
												<td>${contasBaixas.vlrpago}</td>
												<td>${contasBaixas.obs}</td>
												<td width="50" style="text-align:center">
													<a href="<c:url value='/contasBaixas/edit-${contasBaixas.codcontabaixa}' />" class="btn btn-success btn-circle"><i class="fa fa-edit"></i></a>
												    <a href="#" 
												    	class="btn btn-danger btn-circle"
												    	data-href="<c:url value='/contasBaixas/delete-${contasBaixas.codcontabaixa}' />" 
												    	data-toggle="modal" 
