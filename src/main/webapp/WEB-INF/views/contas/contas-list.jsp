                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div>
								<a class="btn btn-primary" href="<c:url value='/contas/new' />">Cadastrar novo</a>
                            </div>
							<br/>
                                ...
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-lista">
                                    ...
                                    <tbody>
										<c:forEach items="${lista}" var="contas">
											<tr class="odd gradeX">
												<td>${contas.codmoeda}</td>
												<td>${contas.tipo}</td>
												<td>${contas.status}</td>
												<td>${contas.numdoc}</td>
												<td>${contas.parcela}</td>
												<td width="50" style="text-align:center">
													<a href="<c:url value='/contas/edit-${contas.codconta}' />" class="btn btn-success btn-circle"><i class="fa fa-edit"></i></a>
												    <a href="#" 
												    	class="btn btn-danger btn-circle"
												    	data-href="<c:url value='/contas/delete-${contas.codconta}' />" 
												    	data-toggle="modal" 
