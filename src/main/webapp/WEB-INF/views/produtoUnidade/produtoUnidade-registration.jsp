                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Cadastro de produtoUnidade
                        </div>
                        <div class="panel-body">
                            <form:form method="POST" modelAttribute="produtoUnidade" class="form form-horizontal has-validation-callback">
                                <form:input type="hidden" path="codprodutounidade" id="codprodutounidade"/>
								...
								<div class="form-group">
									<label class="col-sm-2 control-label" for="inline-suggestions">Sigla:</label>
									<div class="col-sm-8">
										<form:input type="text" path="sigla" id="sigla" class="form-control has-suggestions"/>
	                                    <div class="has-error">
	                                        <form:errors path="sigla" class="label label-danger"/>
	                                    </div>
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="col-sm-8">
                                        <c:choose>
                                            <c:when test="${edit}">
                                                <input type="submit" value="Atualizar" class="btn btn-success custom-width"/> ou <a href="<c:url value='/produtoUnidade/list' />">Desistir</a>
                                            </c:when>
                                            <c:otherwise>
                                                <input type="submit" value="Cadastrar" class="btn btn-success custom-width"/> ou <a href="<c:url value='/produtoUnidade/list' />">Desistir</a>
                                            </c:otherwise>
                                        </c:choose>
									</div>
								</div>
