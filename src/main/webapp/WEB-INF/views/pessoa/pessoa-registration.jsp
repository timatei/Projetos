                        ...
                        <div class="panel-body">
                            <form:form method="POST" modelAttribute="pessoa" class="form form-horizontal has-validation-callback">
								...
								<div class="form-group">
									<label class="col-sm-2 control-label" for="inline-suggestions">Tipo Pessoa:</label>
									<div class="col-sm-8">
								...
								<div class="form-group">
									<label class="col-sm-2 control-label" for="inline-suggestions">Razão Social:</label>
									<div class="col-sm-8">
								...
								<div class="form-group">
									<label class="col-sm-2 control-label" for="inline-suggestions">CNPJ/CPF:</label>
									<div class="col-sm-8">
