                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div>
								<a class="btn btn-primary" href="<c:url value='/parGeral/new' />">Cadastrar novo</a>
                            </div>
							<br/>
                            <div class="dataTable_wrapper">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-lista">
                                    ...
                                    <tbody>
										<c:forEach items="${lista}" var="parGeral">
											<tr class="odd gradeX">
												<td>${parGeral.empresa}</td>
												<td>${parGeral.endereco}</td>
												<td>${parGeral.bairro}</td>
												<td>${parGeral.cidade}</td>
												<td>${parGeral.uf}</td>
												<td width="50" style="text-align:center">
													<a href="<c:url value='/parGeral/edit-${parGeral.codpargeral}' />" class="btn btn-success btn-circle"><i class="fa fa-edit"></i></a>
												    <a href="#" 
												    	class="btn btn-danger btn-circle"
												    	data-href="<c:url value='/parGeral/delete-${parGeral.codpargeral}' />" 
												    	data-toggle="modal" 
