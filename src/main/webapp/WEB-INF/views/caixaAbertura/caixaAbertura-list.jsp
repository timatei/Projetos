                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div>
								<a class="btn btn-primary" href="<c:url value='/caixaAbertura/new' />">Cadastrar novo</a>
                            </div>
							<br/>
                                ...
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-lista">
                                    <thead>
							      		<tr>
									        ...
									        <th>Operador</th>
									        <th>AberturaData</th>
									        <th>FechamentoData</th>
									        <th>Vlrinicial</th>
									        <th width="50" style="text-align:center"></th>
										</tr>
                                    </thead>
                                    <tbody>
										<c:forEach items="${lista}" var="caixaAbertura">
											<tr class="odd gradeX">
												<td>${caixaAbertura.status}</td>
												<td>${caixaAbertura.operador}</td>
												<td>${caixaAbertura.aberturaData}</td>
												<td>${caixaAbertura.fechamentoData}</td>
												<td>${caixaAbertura.vlrinicial}</td>
												<td width="50" style="text-align:center">
													<a href="<c:url value='/caixaAbertura/edit-${caixaAbertura.codcaixaabertura}' />" class="btn btn-success btn-circle"><i class="fa fa-edit"></i></a>
												    <a href="#" 
												    	class="btn btn-danger btn-circle"
												    	data-href="<c:url value='/caixaAbertura/delete-${caixaAbertura.codcaixaabertura}' />" 
												    	data-toggle="modal" 
