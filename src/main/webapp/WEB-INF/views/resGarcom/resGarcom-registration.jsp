                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form:form method="POST" modelAttribute="resGarcon" class="form form-horizontal has-validation-callback">
								...
								<div class="form-group">
									<label class="col-sm-2 control-label" for="inline-suggestions">Perc:</label>
									<div class="col-sm-8">
										<form:input type="text" path="perc" id="perc" class="form-control has-suggestions"/>
	                                    <div class="has-error">
	                                        <form:errors path="perc" class="label label-danger"/>
	                                    </div>
									</div>
								</div>

								<div class="form-group">
									<label class="col-sm-2 control-label" for="inline-suggestions">Entregador:</label>
									<div class="col-sm-8">
										<form:input type="text" path="entregador" id="entregador" class="form-control has-suggestions"/>
	                                    <div class="has-error">
	                                        <form:errors path="entregador" class="label label-danger"/>
	                                    </div>
									</div>
								</div>
